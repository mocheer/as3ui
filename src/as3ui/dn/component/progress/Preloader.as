...
//			progressText.x = this.stage.stageWidth/2 - 152; 
			progressText.x = this.stage.stageWidth/2 ; 
...
//				progressText.text = "加载进度：已加载 " + (event.bytesLoaded/1024).toFixed(0)+ " KB，总大小 " + (event.bytesTotal/1024).toFixed(0)+ " KB."; 
				progressText.text = "加载进度：已加载 " + (event.bytesLoaded/event.bytesTotal*100).toFixed(0)+"%" ; 
			}         
